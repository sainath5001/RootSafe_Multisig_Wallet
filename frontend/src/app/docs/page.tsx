      ...
      <main className="flex-1">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="flex items-center gap-3 mb-8">
            <FaBook className="text-rootstock-orange text-3xl" />
          ...
          <div className="space-y-8">
            ...
            <section className="bg-rootstock-card p-6 rounded-lg">
              <h2 className="text-2xl font-bold text-white mb-4 flex items-center gap-2">
                <FaRocket className="text-rootstock-orange" />
                Quick Start
              </h2>
            ...
            <section className="bg-rootstock-card p-6 rounded-lg">
              <h2 className="text-2xl font-bold text-white mb-4 flex items-center gap-2">
                <FaCode className="text-rootstock-orange" />
                Smart Contract Functions
              </h2>
              <div className="space-y-4">
                <div className="border-l-4 border-[var(--rootstock-orange)] pl-4">
                  <h3 className="text-white font-mono font-semibold">submitTransaction(address to, uint256 value, bytes data)</h3>
                  <p className="text-rootstock-muted text-sm mt-1">Submit a new transaction proposal. Returns transaction ID.</p>
                </div>
                <div className="border-l-4 border-[var(--rootstock-orange)] pl-4">
                  <h3 className="text-white font-mono font-semibold">confirmTransaction(uint256 txId)</h3>
                  <p className="text-rootstock-muted text-sm mt-1">Approve a pending transaction. Can only be called once per transaction per owner.</p>
                </div>
                <div className="border-l-4 border-[var(--rootstock-orange)] pl-4">
                  <h3 className="text-white font-mono font-semibold">revokeConfirmation(uint256 txId)</h3>
                  <p className="text-rootstock-muted text-sm mt-1">Revoke your approval for a pending transaction.</p>
                </div>
                <div className="border-l-4 border-[var(--rootstock-orange)] pl-4">
                  <h3 className="text-white font-mono font-semibold">executeTransaction(uint256 txId)</h3>
                  <p className="text-rootstock-muted text-sm mt-1">Execute a transaction that has met the required confirmations.</p>
                </div>
                <div className="border-l-4 border-[var(--rootstock-orange)] pl-4">
                  <h3 className="text-white font-mono font-semibold">getTransaction(uint256 txId)</h3>
                  <p className="text-rootstock-muted text-sm mt-1">Get transaction details including recipient, amount, data, execution status, and confirmation count.</p>
                </div>
              </div>
            </section>
            ...
            <section className="bg-rootstock-card p-6 rounded-lg">
              <h2 className="text-2xl font-bold text-white mb-4 flex items-center gap-2">
                <FaWallet className="text-rootstock-orange" />
              ...
              <div className="space-y-3">
                <Link
                  ...
                  className="block text-rootstock-orange hover:underline transition-colors"
                >
